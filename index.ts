...
async function main() {
  ...
  // 2. Create an in-memory vector store from the documents using the default Gemini's embeddings
  ...
  Settings.llm = new Gemini({ model: GEMINI_MODEL.GEMINI_PRO_1_5_FLASH,});

//   const agent = new GeminiAgent({llm, });
  // 6. Query the agent
